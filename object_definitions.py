...
def get_OBJ(object_type,goal_no):
    ...
    if object_type == "square_prism":
        ...
        if goal_no == 1:
            ...
            g2 = gPoint(-1.25,-1.25,0)
            g3 = gPoint(1.25,-1.25,0)
            g4 = gPoint(1.25,-1.25,-4)
            goal1 = ConvexPolygon((g1,g2,g3,g4))
            g1 = gPoint(1.25,-1.25,-4)
            g2 = gPoint(1.25,-1.25,0)
            g3 = gPoint(1.25,0.5,0)
            g4 = gPoint(1.25,0.5,-4)
            ...
            g1 = gPoint(-1.25,0,-4)
            g2 = gPoint(-1.25,-1.25,-4)
            g3 = gPoint(1.25,-1.25,-4)
            g4 = gPoint(1.25,0.5,-4)
            goal6 = ConvexPolygon((g1,g2,g3,g4))
            prism = {1:(surf1,n1,goal1),2:(surf2,n2,goal2),3:(surf3,n3),4:(surf4,n4,goal4),5:(surf5,n5),6:(surf6,n6,goal6)}
        elif goal_no == 2:
            # ############ GOAL DEF 2 ############
            g1 = gPoint(-1.25,-1.25,-4)
            g2 = gPoint(-1.25,-1.25,-0.5)
            g3 = gPoint(1.25,-1.25,-0)
            g4 = gPoint(1.25,-1.25,-4)
            goal1 = ConvexPolygon((g1,g2,g3,g4))
            g1 = gPoint(1.25,-1.25,-4)
            ...
            goal4 = ConvexPolygon((g1,g2,g3,g4))
            goal6 = surf6
            prism = {1:(surf1,n1,goal1),2:(surf2,n2,goal2),3:(surf3,n3,goal3),4:(surf4,n4,goal4),5:(surf5,n5),6:(surf6,n6,goal6)}
        elif goal_no == 3:
            # ############ GOAL DEF 3 ############
            g1 = gPoint(-1.25,-1.25,-0)
            g2 = gPoint(-1.25,-1.25,4)
            g3 = gPoint(0.75,-1.25,4)
            g4 = gPoint(0.75,-1.25,0)
            goal1 = ConvexPolygon((g1,g2,g3,g4))
            g1 = gPoint(0.75,1.25,0)
            g2 = gPoint(0.75,1.25,4)
            g3 = gPoint(-1.25,1.25,4)
            g4 = gPoint(-1.25,1.25,0)
            goal3 = ConvexPolygon((g1,g2,g3,g4))
            g1 = gPoint(-1.25,1.25,0)
            g2 = gPoint(-1.25,1.25,4)
            g3 = gPoint(-1.25,-1.25,4)
            ...
            g2 = gPoint(-1.25,1.25,4)
            g3 = gPoint(0.75,1.25,4)
            g4 = gPoint(0.75,-1.25,4)
            goal5 = ConvexPolygon((g1,g2,g3,g4))
            prism = {1:(surf1,n1,goal1),2:(surf2,n2),3:(surf3,n3,goal3),4:(surf4,n4,goal4),5:(surf5,n5,goal5),6:(surf6,n6)}
        elif goal_no == 4:
            # ############ GOAL DEF 4 ############
            g1 = gPoint(1.25,-1.25,0)
            g2 = gPoint(1.25,-1.25,4)
            ...
            g4 = gPoint(1.25,1.25,0)
            goal2 = ConvexPolygon((g1,g2,g3,g4))
            g1 = gPoint(-1.25,-1.25,-2)
            g2 = gPoint(-1.25,-1.25,4)
            g3 = gPoint(-1.25,1.25,4)
            g4 = gPoint(-1.25,1.25,-2)
            goal4 = ConvexPolygon((g1,g2,g3,g4))
            goal5 = surf5
            prism = {1:(surf1,n1),2:(surf2,n2,goal2),3:(surf3,n3),4:(surf4,n4,goal4),5:(surf5,n5,goal5),6:(surf6,n6)}
        elif goal_no == 5:
            # ############ GOAL DEF 5 ############
            g1 = gPoint(-1.25,-1.25,-4)
            ...
            g4 = gPoint(-1.25,0,-4)
            goal4 = ConvexPolygon((g1,g2,g3,g4))
            prism = {1:(surf1,n1,goal1),2:(surf2,n2,goal2),3:(surf3,n3),4:(surf4,n4,goal4),5:(surf5,n5),6:(surf6,n6)}
        elif goal_no == 10:
            g1 = gPoint(-1.25,-1.25,-4)
            g2 = gPoint(-1.25,-1.25,0)
            g3 = gPoint(1.25,-1.25,0)
        ...
        if goal_no == 1:
            ...
            g1 = gPoint(1.5,-1,-4)
            g2 = gPoint(1.5,-1,-0.5)
            g3 = gPoint(1.5,0.25,-0.5)
            g4 = gPoint(1.5,0.25,-4)
            goal2 = ConvexPolygon((g1,g2,g3,g4))
            g1 = gPoint(-1.5,-0.25,-4)
            g2 = gPoint(-1.5,-0.25,-0.5)
            g3 = gPoint(-1.5,-1,-0.5)
            g4 = gPoint(-1.5,-1,-4)
            goal4 = ConvexPolygon((g1,g2,g3,g4))
            g1 = gPoint(-1.5,-0.25,-4)
    ...
    elif object_type == "hexagonal_prism":
        # Hexagonal prism:
        ##################
        # a = 2 cm, h = 3 cm
        h = 1.49*2
